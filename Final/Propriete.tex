...
d'hydrogène se situe de part et d'autre du groupe phényle, il y a des ponts hydrogènes formés à intervalles réguliers.
 ...
 On peut également ajouter que les polymères de Kevlar ont une orientation radiale ( c'est à dire que la longueur de la fibre est parallèle au tissus), c'est pour cela que le Kevlar a une reprise en traction bien plus grande que la reprise en compression.
