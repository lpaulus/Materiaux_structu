...
\begin{wrapfigure}{R}{0.18\textwidth}
 \vspace{-10pt}
\centering
\includegraphics[scale=0.5]{Schema/temp_tract.jpg} 
\vspace{-10pt}
...
\begin{wrapfigure}{L}{0.18\textwidth}
 \vspace{-20pt}
\centering
\includegraphics[scale=0.5]{Schema/temp_young.jpg} 
\vspace{-30pt}
...
\begin{wrapfigure}{R}{0.18\textwidth}
 \vspace{-20pt}
\centering
\includegraphics[scale=0.45]{Schema/dilatationterm.jpg} 
\vspace{-10pt}
...
\begin{wrapfigure}{L}{0.18\textwidth}
 \vspace{-20pt}
\centering
\includegraphics[scale=0.3]{Schema/phkevlar.jpg} 
\vspace{-10pt}
\caption{Effet du PH sur le kevlar}
\vspace{-20pt}
\label{phkevlar}
\end{wrapfigure}


Riewald et al. ont réalisé une étude concernant la résistance des fibres Kevlar 29 et 49. Il en découle que les fibres perdent \unit{1.5}{\%} de leur résistance mécanique après un an d’immersion dans l’eau de mer.CITER LARTICLE
...
\caption{Mécanisme de l’hydrolyse du Kelvar}
\label{hydrolyse}
\end{figure}
